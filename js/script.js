...
{
    document.getElementById('part').innerHTML=`    <div class="body">
    <div class="left-menu">
        <div class="danhmuc">
            <h2>LỌC SẢN PHẨM</h2>
        </div>
...
<div class="trang">
    <div id= "pagination" class="phantrang">
    </div>
</div>`;
}
function hiendn()
{
    document.getElementById('popup').innerHTML=` <div id="popup" class="login-form-container">
    <span onclick ="tat()" id="close-login-form" class="fas fa-times"></span>
    <form action="">
        <h3>Đăng nhập</h3>
        <input type="email" placeholder="Email" class="box">
        <input type="password" placeholder="Mật khẩu" class="box">
        <p> <a onclick="hienquenmk()" href="#">Quên mật khẩu</a> </p>
        <input type="submit" value="Đăng Nhập" class="btn">
        <p> <a onclick ="hiendangky()" href="#">Tạo tài khoản mới</a> </p>
    </form>
</div>`
}
function hiendangky()
{
  document.getElementById('popup').innerHTML=`<div class="login-form-container">
  <span onclick ="tat()" id="close-login-form" class="fas fa-times"></span>
  <form action="">
      <h3>user login</h3>
      <input type="text" placeholder="Tên người dùng" class="box">
      <input type="email" placeholder="Email" class="box">       
      <input type="password" placeholder="Mật khẩu" class="box">
      <input type="password" placeholder="Nhập lại mật khẩu" class="box">
      <input type="submit" value="Đăng ký" class="btn">
      <p> Bạn đã có tài khoản <a onclick="hiendn()" href="#">đăng nhập</a> </p>
  </form>
</div>`
}
function hienquenmk()
        ...
        <div class="sale">\
            ...
            <div class="SLuong">\
                <form>\
                    ...
                    <button onclick="themgiohang('+cars[i].IDxe+')" class="btn"><h3>Thêm giỏ hàng</h3></button>\
                </form>\
            </div>\
            \
        </div>\
...
// window.onload=khoxe(),hienbrand(),phantrang();//,kiemtradadn();
